    ...
    <body class="bg-dark">
        ...
        <div class="container">
            <div class="card card-register mx-auto mt-5">
                ...
                <div class="card-body">
                    <form action="controller/RegisterController"  method="post" class="login100-form validate-form">
                        <div class="form-group">
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="form-label-group">
                                        <input type="text" name="username" class="form-control" placeholder="First name" required="required" autofocus="autofocus">
                        ...
                        <div>
                            <div style="color:red" >${errorMessasge}</div>
                        </div>
                    </form>
